...
import Testimonials_AddForm from "./TestimonialsAdd";
// import Testimonials_AddForm from "./TestimonialsAdd"; // Your testimonials form component
  ...
  return (
    <div>
              ...
              <IconButton
                ...
                onClick={() =>
                  setModalOpen({
                    open: true,
                    mode: 2,
                    rowData: row.original as Testimonial,
                  })
                }
              >
                <Edit />
      ...
      >
        ...
        <DialogContent>
          {modalOpen.open && (
            <Testimonials_AddForm
              mode={modalOpen.mode}
              testimonialData={modalOpen.rowData || undefined}
