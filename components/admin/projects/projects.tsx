...
export default function ProjectsAdmin() {
  ...
  // Load authToken on client side only
  useEffect(() => {
            ...
            <Box sx={{ display: "flex", gap: "0.5rem" }}>
              <Tooltip title="Edit">
                <IconButton
                  color="success"
                  onClick={() =>
                    setModalOpen({ open: true, mode: 2, rowData: row.original as Project })
                  }
                >
                  <Edit />
                </IconButton>
              ...
              <Tooltip title="View">
                <IconButton
                  color="info"
                  onClick={() =>
                    setModalOpen({ open: true, mode: 4, rowData: row.original as Project })
                  }
                >
                  <Visibility />
                </IconButton>
              ...
              <Tooltip title="Delete">
                <IconButton
                  color="error"
                  onClick={() =>
                    setModalOpen({ open: true, mode: 3, rowData: row.original as Project })
                  }
                >
                  <Delete />
                </IconButton>
