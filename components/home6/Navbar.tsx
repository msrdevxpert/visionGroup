...
import logo from "@/public/images/CivilLogo.png";
...
const navbarData = [
          ...
          <nav id="navbar-menu" className="d-flex justify-content-between align-items-center position-relative">
            <ul className="mb-0 menu p-0 py-xxl-2 align-items-lg-center">
              <li className="d-none d-lg-block px-xxl-4">
                <a className="align-items-center gap-2 d-none d-xl-flex outline-btn primary" href="tel:+917601955124">
  ...
  <Link href="/civil/" className="d-flex justify-content-center">
